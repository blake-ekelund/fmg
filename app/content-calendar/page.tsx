  ...
  return (
    <div className="px-4 md:px-8 py-6 md:py-8 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Plan and schedule content across social, email, and blog channels.
          </p>
        </div>
        ...
        <button
          ...
          onClick={() => alert("Add content — coming soon")}
        >
          <Plus size={16} />
          Add Content
        </button>
      ...
      <div className="flex flex-col items-center justify-center py-24 rounded-2xl border border-dashed border-gray-200 bg-white/60">
        ...
        <h3 className="text-sm font-medium text-gray-700 mb-1">Calendar is empty</h3>
        <p className="text-xs text-gray-400 max-w-sm text-center">
          Start planning your content calendar — schedule social posts, blog articles,
          email campaigns, and promotions all in one place.
        </p>
      </div>
    </div>
  );
