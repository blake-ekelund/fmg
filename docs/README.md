...
| [fishbowl-marketplace-field-map.md](./fishbowl-marketplace-field-map.md) | Faire/MarketTime → Fishbowl field contract, the known divergences, and the stock gate | ✅ Written |
